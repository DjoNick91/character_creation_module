...
class Character:
    ...
    def defence(self):
        value_defence = DEFAULT_DEFENCE + randint(*self.RANGE_VAKUE_DEFENCE)
...
def start_training(character: str) -> Character:
    ...
    cmd = None
    game_training = {'attack': character.attack, 'defence': character.defence,
                     'special': character.special
                     }
    while cmd != 'skip':
        cmd = input('Введи команду: ')
        if cmd in game_training.keys():
            print(game_training[cmd])
